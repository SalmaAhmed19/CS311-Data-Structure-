...
//Purpose of the program: **Evaluates postfix expression
//Algorithm: **to evaluate a postfix expression we must implment a stack .Operand are pushed into the stack until an operator is encounter.Once an operator is encoutered two elements are popped from the top of the stack 
  ...
  while (expression[i] != '\0') // til the end of the expression
    {
	 ...
	 cout<<endl;
      ...
      // Error messages describe what is wrong with the expression.
           ...
           //**
	cout<<"The stack is too long ";
	exit( 1);
      }
      catch (stack::Underflow){
	//**
        cout<<"too few opperands";
	exit( 1);
      }
